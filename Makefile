IMG ?= quay.io/kairos/entangle-proxy:test
...
# kairos.io/entangle-proxy-bundle:$VERSION and kairos.io/entangle-proxy-catalog:$VERSION.
IMAGE_TAG_BASE ?= kairos.io/entangle-proxy
