IMG ?= quay.io/c3os/entangle-proxy:test
...
# c3os-x.io/entangle-proxy-bundle:$VERSION and c3os-x.io/entangle-proxy-catalog:$VERSION.
IMAGE_TAG_BASE ?= c3os-x.io/entangle-proxy
